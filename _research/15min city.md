...
description_ko: 근접성, 접근성, 보행 가능성을 통한 도시 공간 재구상
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/15min city.png" title="15-minute city" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
Beyond descriptive analysis, we explore planning and policy levers — from mixed-use zoning and neighborhood service allocation to street redesign and active mobility infrastructure — that can help cities transition toward the 15-minute model. Special attention is given to avoiding gentrification and displacement pressures that can accompany urban retrofitting, ensuring that the benefits of proximity are equitably distributed across all communities.
